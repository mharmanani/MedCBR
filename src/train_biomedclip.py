...
from src.utils.losses import (
    concept_unweighted_ce_loss, 
    concept_weighted_ce_loss
)
...
class BiomedCLIPExperiment:
    ...
    def run_eval_epoch(self, loader, desc="eval"):
        ...
        clf_metrics = compute_classification_metrics(
            ...
            save_threshold=f'/home/harmanan/projects/aip-medilab/harmanan/breast_us/.model-weights/medcbr_epoch{self.epoch}_thresh_fold{self.config.data.fold}.pt',
        )
