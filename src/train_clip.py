...
from src.utils.concept_bank import (
    BREAST_US as BUS_CONCEPT_BANK,
    DDSM as DDSM_CONCEPT_BANK,
    CUB as CUB_CONCEPT_BANK
)
...
class CLIPExperiment:
    ...
    def setup(self):
        ...
        self.CONCEPT_BANK = {
            "BREAST_US": BUS_CONCEPT_BANK,
            "DDSM": DDSM_CONCEPT_BANK,
            "CUB": CUB_CONCEPT_BANK
    ...
    def run_train_epoch(self, loader, desc="train"):
        ...
        epoch_metrics[f"{desc}/contrastive_acc"] = np.mean(all_contrast_accs)
        ...
        #joblib.dump(self.concept_probe, f'{self.config.checkpoint_dir}/concept_probe_epoch{self.epoch}_fold{self.config.data.fold}.joblib')
